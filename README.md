...
-  ORDER BY b.zip, v.risk_category;
      ...
      [Please see page 1 of this data visualization](San_Francisco_Restaurants_Health_Inspection_Analysis.pdf)
      [Please see page 2 of this data visualization](San_Francisco_Restaurants_Health_Inspection_Analysis.pdf) 
...
-  ORDER BY b.zip, year;
      ...
      [Please see page 3 of this data visualization](San_Francisco_Restaurants_Health_Inspection_Analysis.pdf) 
...
-  ORDER BY b.name, year, v.violationtypeid;
      ...
      [Please see page 4 of this data visualization](San_Francisco_Restaurants_Health_Inspection_Analysis.pdf) 
